...
public final class In {
    ...
    ///// begin: section (1 of 2) of code duplicated from fundamentals.ProgrammingModel.In to fundamentals.ProgrammingModel.StdIn.
    ...
    //// end: section (1 of 2) of code duplicated from fundamentals.ProgrammingModel.In to fundamentals.ProgrammingModel.StdIn.
    ...
    public In(File file) {
        ...
        try {
            // for consistency with fundamentals.ProgrammingModel.StdIn, wrap with BufferedInputStream instead of use
    ...
    ////  begin: section (2 of 2) of code duplicated from fundamentals.ProgrammingModel.In to fundamentals.ProgrammingModel.StdIn,
     ...
     * @deprecated Replaced by {@code new fundamentals.ProgrammingModel.In(filename)}.{@link #readAllInts()}.
     */
    @Deprecated
     ...
     * @deprecated Replaced by {@code new fundamentals.ProgrammingModel.In(filename)}.{@link #readAllDoubles()}.
     */
    @Deprecated
    ...
    /**
     * Unit tests the {@code fundamentals.ProgrammingModel.In} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        In in;
        //String urlName = "tinyG.txt";
